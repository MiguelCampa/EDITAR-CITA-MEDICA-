...
import EditorDeCitas.FrontEnd.Editor;
...
public class EditarCitaController  {
    ...
    // Constructor
    public EditarCitaController(Editor view, CitaService service) {
        this.view = view;
    ...
    private void buscarCita() {
        try {
            ...
            if (citaActual != null) {
                ...
                view.getLblFecha().setText(citaActual.getFecha().toString());
                view.getLblHora().setText(citaActual.getHora().toString());
    ...
    private void guardarCita() {
        ...
        try {
            ...
            LocalDate fecha = LocalDate.parse(view.getLblFecha().getText());
            LocalTime hora = LocalTime.parse(view.getLblHora().getText());
            String motivo = view.getTxtMotivo().getText();
            EstadoCita estado = EstadoCita.PROGRAMADA; // temporal
